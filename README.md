...
Pipeline and connector configuration compatibility are in [docs/PIPELINE_COMPATIBILITY.md](docs/PIPELINE_COMPATIBILITY.md); stateful transform requirements are in [docs/STATEFUL_TRANSFORMS.md](docs/STATEFUL_TRANSFORMS.md). The current production-readiness assessment and prioritized alignment plan are in
