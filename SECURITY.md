...
Dependencies come from Maven Central. Dependabot (see `.github/dependabot.yml`) automatically opens
upgrade suggestions. If you find a known vulnerability in a transitive dependency, please report it too.
