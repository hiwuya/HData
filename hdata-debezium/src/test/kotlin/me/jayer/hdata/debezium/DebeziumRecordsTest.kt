...
class DebeziumRecordsTest {
    ...
    @Test
    fun `Envelope converts to a Row`() {
    ...
    @Test
    fun `a non-Envelope record falls back to an r row`() {
    ...
    @Test
    fun `a BYTES field is base64-encoded`() {
    ...
    @Test
    fun `a ByteBuffer field is base64-encoded too`() {
    ...
    @Test
    fun `a Map field converts to a JSON object`() {
    ...
    @Test
    fun `an Array field converts to a JSON array`() {
    ...
    @Test
    fun `a binary primary key is base64-encoded into the key field`() {
    ...
    @Test
    fun `ts_ms is null when its value is missing`() {
    ...
    @Test
    fun `two tables with different structures both map to the fixed output schema`() {
