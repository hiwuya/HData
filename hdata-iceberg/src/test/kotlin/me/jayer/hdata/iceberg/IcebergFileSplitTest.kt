...
class IcebergFileSplitTest {
    ...
    @Test
    fun `a plain read projects only the output data columns, while a filter reads the full data columns`() {
    ...
    @Test
    fun `a binary partition value is serializable and restores to a ByteBuffer`() {
