...
class IcebergPipelineTest {
    ...
    @Test
    fun `a write then read round-trips consistently`() {
    ...
    @Test
    fun `an external table whose field IDs do not start at 1 still writes by the table schema`() {
    ...
    @Test
    fun `a BYTES column round-trips without loss`() {
    ...
    @Test
    fun `write_mode overwrite clears the table first, instead of silently appending`() {
    ...
    @Test
    fun `catalog_name actually takes effect`() {
    ...
    @Test
    fun `two append jobs accumulate data without overwriting each other`() {
    ...
    @Test
    fun `reads are split for parallelism by data file`() {
    ...
    @Test
    fun `a large file is subdivided into multiple parallel splits by split_size`() {
    ...
    @Test
    fun `filter push-down prunes non-matching splits and filters rows`() {
    ...
    @Test
    fun `limit gets the exact row count across files, counted after filtering`() {
    ...
    @Test
    fun `aggregation push-down - count_min_max come from file statistics without reading data`() {
    ...
    @Test
    fun `aggregation push-down - sum_avg accumulate per column and merge globally`() {
    ...
    @Test
    fun `aggregation push-down with a filter counts only matching rows`() {
